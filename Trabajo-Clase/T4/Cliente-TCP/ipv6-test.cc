...
int main( int argc, char * argv[] ) {
   const char * lab/*Server IPv6*/ = "fe80::215:5dff:feb9:69f4%eth0"; // Reemplazando con la interfaz correcta
   
   const char * request = "/aArt/index.php?disk=Disk-01&fig=whale-1.txt";
   ...
   s.Read( a, 512 );
   printf( "%s\n", a);
   //Conexión manual en terminal: curl -g [fe80::8f5a:e2e1:7256:ffe3%enp0s31f6]:80/aArt/index.php?disk=Disk-01&fig=whale-1.txt
